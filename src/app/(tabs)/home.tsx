...
const HomeScreen = (): JSX.Element => {
  ...
  return (
    <ScreenView>
      <TouchableOpacity activeOpacity={0.7} className='w-1/4 flex justify-center items-center m-2 p-2 bg-indigo-600 rounded-full' onPress={switchLanguageHandler}>
      ...
      <ContainerView>
        <View testID='HomeScreen:LottieViewWrapper' className='flex justify-center items-center -mt-20'>
          <LottieView
        ...
        <AppText className='text-center font-medium text-lg my-2'>app.scan_NFC_or_QR</AppText>
        <View testID='HomeScreen:ScanningButtonsWrapper' className='flex-column gap-4 w-[70%] self-center mt-10'>
