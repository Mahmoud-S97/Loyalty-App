      ...
      <ScrollingView>
        <ContainerView>
          <View className='flex-column w-full p-2 justify-center items-center my-7'>
            ...
            <AppText className='text-sm text-center font-bold text-neutral-800 dark:text-neutral-500 mt-4 tracking-wide'>auth.login_entries_with_welcoming_msg</AppText>
          </View>
          <View className='flex w-full p-2'>
            ...
            <MainInputField placeholder='auth.password' icon='lock' className='mt-7' secureTextEntry={!showPassword} isPasswordField={true} toggleShowPassword={toggleShowPassword} value={password} onChangeText={setPasswordHandler} />
