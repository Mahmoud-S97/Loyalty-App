...
const MainInputField = ({ icon, iconSize, iconColor, showPassword, className, textInputClassName, secureTextEntry, placeholder, placeholderTextColor, editable, maxLength, multiline, scrollEnabled, value, onChangeText }: InputFieldProps) => {
